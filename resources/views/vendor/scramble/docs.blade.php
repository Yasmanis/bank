...
<div style="position: fixed; top: 1rem; right: 5rem; z-index: 9999;">
    <a href="{{ route('logout.docs') }}"
       onclick="return confirm('¿Estás seguro de que quieres salir?')"
       style="background-color: #ef4444; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem; font-family: sans-serif; font-weight: bold; text-decoration: none; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1);">
        Cerrar Sesión
    </a>
</div>
<script>
